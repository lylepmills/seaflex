...
local function redraw_screen_game_loading()
  screen.level(5)
  screen.font_face(1)
  screen.font_size(8)
  screen.move(64, 9)
...
local function redraw_screen_game_in_progress()
  if dark_mode then
    screen.level(10)
    screen.font_size(10)
    screen.move(64, 11)
...
local function redraw_screen_game_over()
  screen.level(15)
  screen.font_size(13)
  screen.move(64, 13)
